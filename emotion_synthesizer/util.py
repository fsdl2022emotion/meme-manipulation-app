"""
Modified from https://github.com/full-stack-deep-learning/fsdl-text-recognizer-2022/blob/main/text_recognizer/util.py
"""
import base64
import contextlib
import hashlib
...
def encode_b64_array(array):
    """Encode a numpy array as a base64 string.
    see also: https://discuss.streamlit.io/t/downloading-3d-numpy-arrays/22079
    """
    _buffer = BytesIO()  # bytes that live in memory
    np.save(_buffer, array)  # but which we write to like a file
    encoded_array = base64.b64encode(_buffer.getvalue()).decode("utf8")
